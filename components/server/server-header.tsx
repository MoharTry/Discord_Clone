...
export const ServerHeader = ({
    ...
    return (
        <DropdownMenu>
            ...
            <DropdownMenuContent className="w-56 text-xs font-medium text-black dark:text-neutral-400 dark:bg-[#111214] space-y-[2px]">
                {isModerator && (
                    <DropdownMenuItem
                ...
                {isAdmin && (
                    <DropdownMenuItem
                        className=" dark:text-rose-500 px-3 py-2 text-sm-cursor-pointer">
                        Delete Server
